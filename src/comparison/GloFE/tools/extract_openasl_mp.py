...
def main():
    ...
    arg_dict = {
        ...
        'output_root': '/home/ubuntu/slocal/S2SProsody/data/OpenASL/data/mmpose',
        'args': args,
    }

    all_samples = load_sample_names('/home/ubuntu/slocal/S2SProsody/src/comparison/GloFE/tools/open_asl_all.txt')
